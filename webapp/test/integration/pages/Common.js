sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("demo/train/app", ".html");
		...
		return Opa5.extend("demo.train.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["demo/train/localService/mockserver"], function (mockserver) {
